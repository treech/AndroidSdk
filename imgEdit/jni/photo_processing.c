...
int Java_io_github_treech_PhotoProcess_nativeInitBitmap(JNIEnv* env, jobject thiz, jint width, jint height) {
    return initBitmapMemory(&bitmap, width, height);
}

//

void Java_io_github_treech_PhotoProcess_nativeGetBitmapRow(JNIEnv* env, jobject thiz, jint y, jintArray pixels) {
...
void Java_io_github_treech_PhotoProcess_nativeSetBitmapRow(JNIEnv* env, jobject thiz, jint y, jintArray pixels) {
    int cpixels[bitmap.width];
    (*env)->GetIntArrayRegion(env, pixels, 0, bitmap.width, cpixels);
    setBitmapRowFromIntegers(&bitmap, (int)y, &cpixels);
}

int Java_io_github_treech_PhotoProcess_nativeGetBitmapWidth(JNIEnv* env, jobject thiz) {
    return bitmap.width;
}

int Java_io_github_treech_PhotoProcess_nativeGetBitmapHeight(JNIEnv* env, jobject thiz) {
    return bitmap.height;
}

void Java_io_github_treech_PhotoProcess_nativeDeleteBitmap(JNIEnv* env, jobject thiz) {
    deleteBitmap(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeFlipHorizontally(JNIEnv* env, jobject thiz) {
    flipHorizontally(&bitmap, 1, 1, 1);
}

int Java_io_github_treech_PhotoProcess_nativeRotate90(JNIEnv* env, jobject thiz) {
...
void Java_io_github_treech_PhotoProcess_nativeRotate180(JNIEnv* env, jobject thiz) {
    rotate180(&bitmap, 1, 1, 1);
}

void Java_io_github_treech_PhotoProcess_nativeApplyInstafix(JNIEnv* env, jobject thiz) {
    applyInstafix(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyAnsel(JNIEnv* env, jobject thiz) {
    applyAnselFilter(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyTestino(JNIEnv* env, jobject thiz) {
    applyTestino(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyXPro(JNIEnv* env, jobject thiz) {
    applyXPro(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyRetro(JNIEnv* env, jobject thiz) {
    applyRetro(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyBW(JNIEnv* env, jobject thiz) {
    applyBlackAndWhiteFilter(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplySepia(JNIEnv* env, jobject thiz) {
    applySepia(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyCyano(JNIEnv* env, jobject thiz) {
    applyCyano(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyGeorgia(JNIEnv* env, jobject thiz) {
    applyGeorgia(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplySahara(JNIEnv* env, jobject thiz) {
    applySahara(&bitmap);
}

void Java_io_github_treech_PhotoProcess_nativeApplyHDR(JNIEnv* env, jobject thiz) {
    applyHDR(&bitmap);
}

int Java_io_github_treech_PhotoProcess_nativeLoadResizedJpegBitmap(JNIEnv* env, jobject thiz, jbyteArray bytes, jint jpegSize, jint maxPixels) {
...
int Java_io_github_treech_PhotoProcess_nativeResizeBitmap(JNIEnv* env, jobject thiz, jint newWidth, jint newHeight) {
...
Java_io_github_treech_PhotoProcess_freeBeautifyMatrix(JNIEnv *env, jobject obj) {
    freeMatrix();
}

JNIEXPORT void JNICALL
Java_io_github_treech_PhotoProcess_handleSmoothAndWhiteSkin(JNIEnv *env, jobject obj, jobject bitmap,
...
JNIEXPORT void JNICALL
Java_io_github_treech_PhotoProcess_nativeMosaic(JNIEnv *env, jclass type, jobject bitmap,
                                                  jobject out_bitmap,
                                                  jint radius) {
    AndroidBitmapInfo info;
    void *pixels;
