...
import io.github.treech.common.config.CommonLibConfig
...
object FileTool {
    ...
    fun getBasePath(): String {
        var p: String? = CommonLibConfig.instance!!.application.getExternalFilesDir(null)?.path
        val f: File? = CommonLibConfig.instance!!.application.getExternalFilesDir(null)
        if (null != f) {
            p = f.absolutePath
        }
        return p ?: ""
