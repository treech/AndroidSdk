...
package io.github.treech.ui.widget.imageview.preview.ui;
...
import io.github.treech.ui.utils.CollectionUtils;
import io.github.treech.ui.widget.imageview.preview.MediaLoader;
import io.github.treech.ui.widget.imageview.preview.PreviewBuilder;
import io.github.treech.ui.widget.imageview.preview.enitity.IPreviewInfo;
import io.github.treech.ui.widget.imageview.preview.view.BezierBannerView;
import io.github.treech.ui.widget.imageview.preview.view.PhotoViewPager;
import io.github.treech.ui.widget.imageview.preview.view.SmoothImageView;
            ...
            for (int i = 0; i < size; i++) {
                fragments.add(BasePhotoFragment.
                        newInstance(className, imgUrls.get(i),
                                currentIndex == i,
                                getIntent().getBooleanExtra(BasePhotoFragment.KEY_SING_FILING, false),
                                getIntent().getBooleanExtra(BasePhotoFragment.KEY_DRAG, false),
                                getIntent().getFloatExtra(BasePhotoFragment.KEY_SENSITIVITY, 0.5f),
                                getIntent().getIntExtra(BasePhotoFragment.KEY_PROGRESS_COLOR, R.color.xui_config_color_main_theme))
                );
            }
        } else {
            finish();
