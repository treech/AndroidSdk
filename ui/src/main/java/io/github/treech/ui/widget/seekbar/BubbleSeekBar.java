package io.github.treech.ui.widget.seekbar;

import static io.github.treech.ui.widget.seekbar.BubbleUtils.dp2px;
import static io.github.treech.ui.widget.seekbar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.xui_config_color_main_theme));
