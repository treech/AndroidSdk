package io.github.treech.ui.checkbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_FLOOR_CHECKED = Color.parseColor("#DFDFDF");
    ...
    private int mCheckedColor, mUnCheckedColor, mFloorColor, mFloorUnCheckedColor, mFloorCheckedColor;

    private boolean mChecked;
    private boolean mTickDrawing;
    private boolean mStrokeKeep;
    ...
    private void reset() {
        ...
        mFloorColor = isChecked() ? mFloorCheckedColor : mFloorUnCheckedColor;
    ...
    private void drawCenter(Canvas canvas) {
        mPaint.setColor(isChecked() ? mCheckedColor : mUnCheckedColor);
        float radius = (mCenterPoint.x - mStrokeWidth) * (mStrokeKeep ? 1.0f : mScaleVal);
